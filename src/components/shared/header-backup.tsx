...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-500 bg-white/5 border-b border-white/10 backdrop-blur-xl shadow-lg">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-px">
          ...
          <div className="absolute -top-1 left-0 right-0 h-2 bg-gradient-to-r from-transparent via-primary/10 to-transparent blur-sm"></div>
        </div>
            ...
            <div className="lg:hidden relative rounded-2xl mt-4 p-6 space-y-6 border border-white/10 shadow-xl backdrop-blur-md overflow-hidden">
              ...
              <nav className="flex flex-col space-y-2">
                <Link 
                  ...
                  className={`relative transition-all duration-300 text-xl font-normal hover:font-medium text-left py-3 px-4 rounded-lg hover:bg-white/10 group ${
                    pathname === '/' 
                      ? 'text-white bg-gradient-to-r from-primary/20 to-blue-400/20 border-l-4 border-primary' 
                      : 'text-gray-300 hover:text-white'
                  }`}
                >
                  <span className="relative z-10">Home</span>
                  {pathname !== '/' && (
                    <div className="absolute inset-0 bg-gradient-to-r from-primary/10 to-blue-400/10 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  )}
                </Link>
                <Link 
                  href="/services"
              ...
              <div className="border-t border-white/20 pt-6 space-y-3">
                ...
                <Button 
                  ...
                  className="w-full bg-primary hover:bg-primary/90 text-white text-lg rounded-lg"
                >
                  Sign Up
                </Button>
              </div>
